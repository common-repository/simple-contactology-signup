...
class Contactology {
	...
	/**
	 * Add a single e-mail address - does not support Custom Fields
	 *
	...
	/**
	 * Add multiple e-mail addresses - does not support Custom Fields
	 *
	 ...
	 *  - customFieldId => value
	 * 
	 * Each contact struct must have a valid e-mail
	 * 
	 * Ex:
	 * contacts = [
	 ...
	 * 
	 *
	 * @return array Returns an array containing the e-mail addresses of active contacts
	 */ 
	 ...
	 * 
	 *
	 * @param string email The e-mail address of the contact you want information for
	 * @param struct optionalParameters A struct of optional parameters, see below for valid keys
	 * @return struct Returns a struct of structs, keyed off of e-mail address, each containing the keys specified above
	 */ 
	 ...
	 * </structnotes customFields>
	 *
	 * @param string email The e-mail address of the contact you want to update
	...
	/**
	 * Change the e-mail address for an existing contact while preserving list and group subscriptions
	 *
	 * Once you change the contact's e-mail address, you will need to use the new e-mail address to access the contact
	 *
	 * @param string email The current e-mail address of the contact
	 * @param string newEmail The contact's new e-mail address
	 * @return struct Returns a struct of structs, keyed off of e-mail address, each containing the keys specified below
	 */ 
	 ...
	 * 
	 *
	 * @param string email The e-mail address of the contact you wish to activate
	 * @return bool Returns true on success
	 */ 
  ...
  specified lists.
	 ...
	 *
	 * @param string email The e-mail address of the contact you wish to set the subscriptions of
	...
	/**
	 * Get a list of all e-mail addresses that are not subscribed to any list
	 *
	 * 
	 *
	 * @return array A list of e-mail addresses that are not subscribed to any list
	 */ 
	...
	/**
	 * Delete all e-mail addresses that are not subscribed to any list
	 *
	 * 
	 *
	...
	/**
	 * Add a E-mail CustomField to your signup form
	 *
	 * The CustomField token will be automatically generated based on the fieldName you provide
	 *
	 * @param string fieldName The name of your CustomField - this will be the label for your field on the form
	...
	/**
	 * Add an e-mail address contact to an existing list
	 *
	 * 
	 *
	 * @param int listId The ID of the list you want to subscribe the e-mail address to
	 * @param string email The e-mail address you are subscribing
	 * @param struct optionalParameters A struct of optional parameters, see below for valid keys
	...
	/**
	 * Remove an e-mail address contact from an existing list
	 *
	 * 
	 *
	 * @param int listId The ID of the list you want to unsubscribe the e-mail address from
	 * @param string email The e-mail address you are unsubscribing
	 * @param struct optionalParameters A struct of optional parameters, see below for valid keys
	 * @return bool True on success
	 */ 
	...
	/**
	 * Remove multiple e-mail address contacts from an existing list
	 *
	 * 
	 *
	 * @param int listId The ID of the list you want to unsubscribe the e-mail address from
	 * @param array emails An array of e-mail addresses you are unsubscribing
	 ...
	 *  - customFieldId => value
	 * 
	 * Each contact_hash must have a valid e-mail
	 * 
	 * Ex:
	 * contacts = [
	 * {'email':'test@contactology.com', 'first_name':'Test', 'last_name':'User'},
	 ...
	 * @param string status Retrieve only contacts with a particular status, valid values: subscribed, unsubscribed, bounced (defaults to subscribed)
	 ...
	 *  - easycastName: A one word shortcut for EasyCast access, will create an EasyCast e-mail address in the format NAME.list.YOURID@send.emailcampaigns.net
	 *  - listOwnerEmail: An e-mail address that receives an email whenever a contact subscribes to this list, and can approve "EasyCast" messages
	 *
	 ...
	 *  - string easycastName A one word shortcut for EasyCast access, will create an EasyCast e-mail address in the format NAME.list.YOURID@send.emailcampaigns.net
	 *  - string listOwnerEmail An e-mail address that receives an email whenever a contact subscribes to this list, and can approve "EasyCast" messages
	 ...
	 *  - string optInFromEmail The e-mail address that the optInMessage confirmation e-mail will be sent from.  Required if optIn is true
	 *  - string optInFromEmailAlias The From Name that the optInMessage confirmation e-mail will be sent from.
	 *  - string optInSubject The subject line of the optInMessage confirmation e-mail.  Required if optIn is true
	 *  - string optInMessage The HTML e-mail body for the confirmation e-mail. MUST include the {confirm_url} token that will insert the link to the correct subscription confirmation page.  Required if optIn is true
	 * 
	 * Example optInMessage:
	 * 
	 * <!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
	...
	/**
	 * Add an e-mail address contact to an existing group
	 *
	 * 
	 *
	 * @param int groupId The ID of the group you want to subscribe the e-mail address to
	 * @param string email The e-mail address you are subscribing
	 * @return bool True on success
	 */ 
	...
	/**
	 * Remove an e-mail address contact from an existing group
	 *
	 * 
	 *
	 * @param int groupId The ID of the group you want to unsubscribe the e-mail address to
	 * @param string email The e-mail address you are unsubscribing
	 * @return bool True on success
	 */ 
	...
	/**
	 * Remove multiple e-mail address contacts from an existing group
	 *
	 * 
	 *
	 * @param int groupId The ID of the group you want to remove the e-mail address from
	 * @param array emails An array of e-mail addresses you are removing from the group
	 * @return int Returns the number of contacts removed
	 */ 
	 ...
	 * @param struct optionalParameters A struct of optional parameters, see below for valid keys
	 * @return struct Struct of records each with a key of the contact's e-mail addressemail and values of contactId, email, status and statusCode
	 */ 
	 ...
	 *  - customFieldId => value
	 * 
	 * Each contact must have a valid e-mail
	 * 
	 * Ex:
	 * contacts = [
	 * {'email':'test@contactology.com','first_name':'Test','last_name':'User'},
	 ...
	 * @param string senderEmail The from e-mail address of the Campaign
	 * @param string senderName The from name of the Campaign
	 * @param struct content A struct which specifies the of the Campaign e-mail - can include html and text
	 * @param struct optionalParameters A struct of optional parameters, see below for valid keys
	 ...
	 * @param string senderEmail The from e-mail address of the Campaign
	 * @param string senderName The from name of the Campaign
	 * @param struct content A struct which specifies the URLs that hold the of the Campaign e-mail - can include htmlUrl and textUrl
	 * @param struct optionalParameters A struct of optional parameters, see below for valid keys
	 * @return int campaignId The ID for your new Campaign
	 */ 
	...
	/**
	 * Create a campaign to be sent to an ad hoc list of e-mail addresses.  The campaign will send immediately, it is not necessary to call Campaign_Send
	 *
	 ...
	 *  - with a specific domain name in their e-mail address
	 ...
	 * 
	 * If the content of your e-mail included a string {activation_code}, your replacements could contain {'activation_code':'123'},
	 ...
	 * </structnotes content>
	 *
	 * @param struct testContact An initial contact to receive a test copy of the transactional e-mail
...
The recipients are added and will be sent in the next send cycle. This can be used to send transactional or ongoing type messages. In this
	 ...
	 *  - customFieldId => value
	 * 
	 * A contact must have a valid e-mail
	 * 
	 * Ex:
	 ...
	 *    * 'Tuesday next week' (example)
	 * 
	 * The timeString must specify a time in the future.  No time travelling to send e-mails is allowed
	 * </structnotes time>
	 *
	...
	/**
	 * Get the total number of sent e-mails for your account
	 *
	 * 
	 *
...
Campaign and SavedSearch functions
	...
	/**
	 * Get a Contactology Message Quality Score for an e-mail
	 *
	 * 
	 *
	 * @param string fromEmail The e-mail address your e-mail will be sent from
	 * @param string subject The of your e-mail
